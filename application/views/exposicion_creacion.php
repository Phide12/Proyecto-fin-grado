<?php if (isset($_SESSION['es_Admin'])) : ?>
  <main>
    <div class="container">
      ...
      <?php if (isset($error)) {
        echo '<div class="contenedor-secundario bg-white">' . $error . '</div>';
      } ?>
      <div class="contenedor-secundario bg-white formulario">
        <div class="formulario">
          <form method="post" id="crear_exposicion" name="crear_exposicion" enctype="multipart/form-data">
            ...
            <input type="submit" name="crear" value="Crear" formaction="<?= base_url() . 'index.php/exposicion/insertar_exposicion'; ?>">
          </form>
        </div>
      </div>
    </div>
  </main>
  <script src="<?= base_url(); ?>recursos/javascript/exposicion/crearExposicion.js"></script>
<?php endif; ?>
</body>
